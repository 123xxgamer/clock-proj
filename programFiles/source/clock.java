...
public void clockFrame(int x, int y, int size){
  fill(0,0,100);
...
public void ticks(){
  ...
  for (int i=0;i<60;i++) {
    rads=radians(i*6);
    stroke(0,0,100);
    int outerX=PApplet.parseInt(CLOCKRADIUS*cos(rads)+CENTERX);
    int outerY=PApplet.parseInt(CLOCKRADIUS*sin(rads)+CENTERY);
...
public void labels(){
  ...
  text("12", CENTERX, (0.9f*height)/4);
  text("6", CENTERX, (3.1f*height)/4);
  text("9",(0.9f*width)/4, CENTERY);
  text("9",(0.9f*width)/4, CENTERY);
  text("3",(3.1f*width)/4, CENTERY);
}
...
public int outX(int t, int mult) {
  return PApplet.parseInt(CLOCKRADIUS*cos(radians(t*mult+270))+CENTERX);
}
public int outY(int t, int mult) {
  return PApplet.parseInt(CLOCKRADIUS*sin(radians(t*mult+270))+CENTERX);
}
...
public void digital(){
  ...
  stroke(15,15,140);
  fill(0,0,100);
  rect(CENTERX/1.3f, CENTERY+height/18, width/4.3f, height/10, 10);
  textSize(30);
  fill(255,255,0);
